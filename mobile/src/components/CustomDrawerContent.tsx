...
export default function CustomDrawerContent(props: any) {
  ...
  const loadLocalUser = async () => {
    ...
    const cachedBalance = await AsyncStorage.getItem("atcBalance");
  ...
  try {
    ...
    await AsyncStorage.setItem("atcBalance", bal);

  } catch (err) {
    console.log("Drawer fetch failed");
  }
...
function SettingRow({icon,label,value,onChange}:any){
